...
- `CoTWithSCAAgent`: CoT agent with sufficient context autorater
"""
...
class CoTWithSCAAgent(Agent):
    """
    Agent to implement cot evaluation with sufficient context autorater.
    """
