...
class SufficientContextAutoraterPrompt(LLMPrompt):
  SUFFICIENT_CONTEXT_AUTORATER_INSTURCTION = f"""
  ...
  Output the ### EXPLANATION. Then, use the EXPLANATION to output the ### JSON.
  Keep the ### EXPLANATION short. DO NOT include any additional information in ### JSON.
  ...
  def get_prompt(self, prolog_query: bool = False) -> PromptTemplate:
      ...
      return PromptTemplate(
          ...
          template=self.SUFFICIENT_CONTEXT_AUTORATER_INSTURCTION,
      )
