...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--sca_evidence_path", type=str, help="Path to the evidence generated by the sufficient context autorater"
    )
    parser.add_argument(
        "--reranker_evidence_path", type=str, help="Path to the evidence generated by the reranker"
    )
